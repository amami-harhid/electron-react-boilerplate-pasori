...
export const Masterhead = () => {
	...
	<><div className="mainHeader">
			<Button variant="contained" color="primary" onClick={readerForceStart}
				style={(readerIsError) ? { display: "inline-block", zIndex:100, height:50 } : { display: "none" }}
				>障害中</Button>
			<Button variant="contained" color="primary" disabled={true}
				style={(readerIsError) ? { display: "none" } : { display: "inline-block", color:"#ffffff", zIndex:100, height:50 }}
